...
test_preds = np.mean((test_preds1, test_preds2, test_preds3, test_preds4, test_preds5), axis=0)
...
train_preds = np.mean((train_preds1, train_preds2, train_preds3, train_preds4, train_preds5), axis=0)
